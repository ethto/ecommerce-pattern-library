 ...
 * @version 1524179487943
 */
const patternManifest_1524179487943 = {
  "commonInfo": {
    "modulifier": [
      "responsive",
      "images",
    ...
    "readme": {
      ...
      "bodyBasic": "bubbl is a service that provides completely customizable bubble wrap. Colour, size, shapes, textures, and even scents—absolutely anything is possible."
    },
    "icons": [
      "facebook-logo",
      "insta-logo",
...
patternBotIncludes(patternManifest_1524179487943);
}());